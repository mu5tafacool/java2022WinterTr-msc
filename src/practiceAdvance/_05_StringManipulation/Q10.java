...
public class Q10 {
	 ...
	 */
        ...
        String adSoyad = "John White";

        //ad ve soyad birlesik verildiginde bunlari yazdirma

        String adYazi= adSoyad.charAt(0) + adSoyad.substring(1,(adSoyad.indexOf(" "))).replaceAll("\\w","*");
        System.out.println("adYazi = " + adYazi);
                                //bosluktan sonraki karakteri al + bosluktan sonraki 2. karakter sonrasini * yap
        String soyadYazi= adSoyad.charAt(adSoyad.indexOf(" ")+1) + adSoyad.substring((adSoyad.indexOf(" "))+2).replaceAll("\\w","*");
        System.out.println("soyadYazi = " + soyadYazi);

        System.out.println("AD SOYAD = " + adYazi +" "+ soyadYazi);
