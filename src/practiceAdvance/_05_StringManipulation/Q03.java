...
public class Q03 {
    public static void main(String[] args) {
        ...
        */
        ...
        String ad1 = "Ahmet Emin Yılmaz";

        String a = ad1.substring(0, 1); //A
        String b = ad1.substring(ad1.indexOf(" ") + 1, ad1.indexOf(" ") + 2); //E
        String c = ad1.substring(ad1.lastIndexOf(" ")+1, ad1.lastIndexOf(" ")+2); //Y
