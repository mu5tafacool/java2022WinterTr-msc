...
public class A_StringMethods {
    public static void main(String[] args) {
        ...
        // ss'in ilk karakteri haric, * ile gizleyin, geriye kalanlar normal yazilsin
        System.out.println(ss.substring(0,1)+ss.substring(1).replaceAll("\\w", "*"));//H** **** **** **** ****
        System.out.println("----------");
        ...
        * Replace ile aynı sadece ilk bulunanı değiştirir
        ...
        System.out.println("REPLACEaLL METODU>>>> " + numara.replaceAll("[a-zA-Z]", "")); //$1800 //harfleri replace degistirme
        System.out.println("REPLACEaLL METODU>>>> " + numara.replaceAll("[0-9]", "")); //$ Milyon //rakamlari degistirme
        System.out.println("----------");
