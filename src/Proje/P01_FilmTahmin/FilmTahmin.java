...
public class FilmTahmin {
    ...
    public static void main(String[] args) {
        ...
        filmGetir(filmler, secilenFilmIndex - 1); //film ve secilenin bir eksigi (cunku list te 0 dan basliyor) aliyoruz method icin
    ...
    private static void filmGetir(List<String> film, int index) {
        ...
        System.out.println(tahminEdilecekFilm); //StringBuilder i atmayi methodla direk yapariz string e gore kolay yaptigimizdan yaptik
        ...
        String str = ""; //kanteyner dir. alinan harfleri burda tutarak string olarak contains ediyoruz tahmin edilenle
