package src.Proje.P04_okulYönetimi.ogrcOgrtYonetimi.ogrcOgrtYonetimi01;
...
public class Islemler {
    ...
    public static final String W = "\u001B[37m"; //whire
    ...
    public static void girisPaneli() {
        ...
        switch (secim) {
            case "1":
                kisiTuru = "OGRENCI"; //secilen ogrenci oldugundan atama yapiyoruz kisiturune
                islemMenusu();
                break;
            case "2":
                kisiTuru = "OGRETMEN";
