...
public class Q02_AtbashCode {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("sifrelenecek ifadeyi giriniz :"); //ey edip ye
        String ifade = scan.nextLine().toLowerCase();
        for (int i = 0; i < ifade.length(); i++){
            int index = 'z'-ifade.charAt(i); // "abcdefghijklmnopqrstuvwxyz"; z den i=b ciktiginda index olarak 2 dir
                                              //"zyxwvutsrqponmlkjihgfedcba";  z den 2 index y dir
            // tesrten bakacagi icin sondan cikardik, bir nevi kayma miktarini bulduk..
            System.out.print((char)(('a') + index)); //vb»vwrk»bv
