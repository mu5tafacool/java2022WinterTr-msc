...
public class Q02_2D_CollectionsTask {
    ...
    // Bu 3 ArrayList'i Multi Dimensions Array 2D ArrayList'te saklayın
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> isverenler = new ArrayList<>(List.of("Haluk","Eylul","Yusuf","Can","İbrahim","Mehmet"));
