package src.interview_Question.interviewQuestions8;
...
public class Q03_CollectionsMethodsTask {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("**********RANDOM ILE ARRAY OLUSTURMALI***************");
        List<Integer> List = new ArrayList<>();
        Random rand = new Random();
        for (int i = 0; i < 5; i++) {
            List.add(rand.nextInt(100)); // 2. alternatif  List.add((int)(Math.random()*100));
        }
        ...
        Collections.shuffle(List); //Array i Shuffle yapiyor karistiriyor
        System.out.println("shuffle(List) = " + List);
        Collections.rotate(List, 3); //3 uncu index den sonrasini yazdirma kaydirma gibi
        //        (List) = [41, 51, 99, 58, 13]
        //rotate(List,3) = [99, 58, 13, 41, 51]
